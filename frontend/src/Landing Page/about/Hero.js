...
function Hero() {
    return (
        <div className='container'>
            <div className='row border-bottom text-center mt-2 mb-5'>
                <h1 className='text-center fs-3 mt-5 mb-5 p-5 text-muted'>We pioneered the discount broking model in India.<br></br>
                    Now, we are breaking ground with our technology.</h1>
            </div>
            <div className='row text-muted fs-5 mb-5'>
                ...
                <div className='col-4'>
                   ...
                   <a href="#"> Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.
                    ...
                    <a>blog</a> or see what the media is 
                    <a>saying about us</a>.
                    </p>
                </div>
                <div className='col'></div>
